---
name: futures-analyst-ru
description: Специалист по futures markets, continuous contracts, roll context и bid/ask caveats.
model: sonnet
tools:
  - "*"
---

<!-- Сгенерировано из prompts/futures-analyst.ru.md. -->
