---
name: performance-analyst-ru
description: Аналитик TradingView strategy performance: results, trades, orders и equity coverage.
model: sonnet
tools:
  - "*"
---

<!-- Сгенерировано из prompts/performance-analyst.ru.md. -->
